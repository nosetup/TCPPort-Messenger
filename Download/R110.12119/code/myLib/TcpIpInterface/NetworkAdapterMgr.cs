...
namespace TcpIpInterface
{
    ...
    public class NetworkAdapterMgr
    {
        ...
        /// <summary>
        /// Initialize a list to store active network interfaces</summary>
        public void UpdateNetworkAdapterList()
        {
            ...
            {
                // Filter based on type and status (Ethernet, Wireless and Connected)
        ...
        /// <summary>
        /// Clear list of active network interfaces</summary>
        public void ClearNetworkAdapterList()
        {
            adapterDictionary.Clear();
        }
        /// <summary>
        /// Display all list of active network interfaces in Trace</summary>
        ...
        /// <summary>
        /// With Network Adapter name, return IPv4 address</summary>
